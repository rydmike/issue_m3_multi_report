...
//
// with AleDemoPage added.
// Available as gist:
// https://gist.github.com/rydmike/70a937dae2c37bdab9a33bcd3212f912
// And DartPad:
// https://dartpad.dev/?id=70a937dae2c37bdab9a33bcd3212f912
//
...
class DemoAlePage extends StatelessWidget {
  const DemoAlePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Demo Ale Page')),
      body: const SafeArea(
        child: Center(
          child: Text('This is demo Ale page.'),
        ),
      ),
    );
  }
